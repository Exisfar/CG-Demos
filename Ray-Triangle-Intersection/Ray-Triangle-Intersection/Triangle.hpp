...
bool rayTriangleIntersect(const Vector3f& v0, const Vector3f& v1,
  ...
  // uses barycentric coordinates for the parametric plane containing the triangle
  float a = v0.x - v1.x, b = v0.y - v1.y, c = v0.z - v1.z;
  float d = v0.x - v2.x, e = v0.y - v2.y, f = v0.z - v2.z;
  float g = dir.x, h = dir.y, i = dir.z;
  float j = v0.x - orig.x, k = v0.y - orig.y, l = v0.z - orig.z;
